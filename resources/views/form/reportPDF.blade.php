        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title">Report Leave PDF <span id="year"></span></h3>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('home') }}">Report</a></li>
                            <li class="breadcrumb-item active">PDF Format</li>
                        </ul>
                    </div>
            ...
            <div class="row filter-row">
                ...
                <div class="col-sm-6 col-md-3 col-lg-3 col-xl-2 col-12">
                    <a href="{{ route('getreportPdf')}}" class="btn btn-success btn-block"> Download </a>
                </div>
            </div>
            <!-- /Search Filter -->
