        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title">Approval Sick Leaves Supervisor Levels <span id="year"></span></h3>
                        <ul class="breadcrumb">
                                            ...
                                            <td class="text-center">
                                                <div class="dropdown dropdown-action">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a class="dropdown-item" href="{{url('form/sickApprove/app1/acc/'.$items->id)}}"onclick="return confirm('Are you sure to want to approve it?')"><i class="fa fa-check m-r-5"></i> Approve</a>
                                                        <a class="dropdown-item" href="{{url('form/sickApprove/app1/decline/'.$items->id)}}"onclick="return confirm('Are you sure to want to decline it?')"><i class="fa fa-trash-o m-r-5"></i> Decline</a>
                                                    </div>
                                                </div>
                                            </td>
